...
public class BlockPlacementPolicyDefault extends BlockPlacementPolicy {
  ...
  protected Node chooseTargetInOrder(boolean ishotfile, boolean iscoldfile,int numOfReplicas, 
    ...
    if (numOfResults>3 && ishotfile) {
    	chooseTargetForEAFR(1,excludedNodes,blocksize,maxNodesPerRack,results,avoidStaleNodes,storageTypes);
  ...
  protected DatanodeDescriptor chooseTargetwithHighestStorage (int numOfReplicas, 
          final Set<Node> excludedNodes,
          final long blocksize,
          final int maxNodesPerRack,
          final List<DatanodeStorageInfo> results,
	  ...
	  NavigableMap<Double,DatanodeStorageInfo> preferCapacity= new TreeMap<Double,DatanodeStorageInfo>();
	  ArrayList<Long> durations= new ArrayList<Long>();
	  TreeMap<Long,DatanodeStorageInfo> ewma= new TreeMap<Long,DatanodeStorageInfo>();
	  NavigableMap<Double,DatanodeStorageInfo> preferDelay= new TreeMap<Double,DatanodeStorageInfo> ();
	  HashMap<DatanodeStorageInfo,Double> revPreferCapacity= new HashMap<DatanodeStorageInfo,Double>();
	  HashMap<DatanodeStorageInfo,Double> revPreferDelay= new HashMap<DatanodeStorageInfo,Double>();
	  NavigableMap<Double,DatanodeStorageInfo> weightedProbability= new TreeMap<Double,DatanodeStorageInfo>();
	  @SuppressWarnings("null")
	
	  long pastvalue=(Long) null;
	  double alpha=.8;
...
protected long  EWMA(long value,double alpha,long oldvalue) {
 if (oldvalue==(Long)null) {
  ...
  protected DatanodeStorageInfo chooseTargetForEAFR(int numOfReplicas,
          Set<Node> excludedNodes,
          long blocksize,
          int maxNodesPerRack,
...
DatanodeDescriptor chosenNode = chooseTargetwithHighestStorage ( numOfReplicas, excludedNodes,blocksize,maxNodesPerRack,results,
		avoidStaleNodes,storageTypes);
if (chosenNode == null) {
break;
}
...
return firstChosen;
 ...
 // protected DatanodeStorageInfo chooseTar
